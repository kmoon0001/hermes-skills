...
- **Gmail SMTP for cron job delivery:** For automated email from cron jobs (no CLI needed), see `references/gmail-smtp-cron-delivery.md` — covers app password setup, smtplib integration, and pitfalls.
